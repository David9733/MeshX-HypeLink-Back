...
| 헥사고날<br>구조 | `/usecase/port/NoticeUseCase.java`<br>`/adaptor/in/WebAdaptor.java`<br>`/adaptor/out/NoticePersistenceAdaptor.java` | WebAdaptor → UseCase → PersistenceAdaptor 계층 분리<br>포트 인터페이스로 의존성 역전<br> 도메인 로직이 외부 기술에<br> 의존하지 않는 구조 설계 |
